...
export default function TimelineToolbar({
  ...
  async function handlePlay(lane?: "a" | "b") {
    let devs = devices;
    if (devs.length === 0) {
      await fetchDevices();
    ...
    await start("timeline", timeline.id, ids, lane);
  }

  return (
    <div className="flex items-center gap-4 px-5 py-2.5 border-b border-zinc-800/60 bg-zinc-900/50">
